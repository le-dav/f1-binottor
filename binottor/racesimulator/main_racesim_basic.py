    ...
    if sim_opts["use_qp"]:
        ...
        for cur_no_pitstops in range(sim_opts["min_no_pitstops"], sim_opts["max_no_pitstops"] + 1):
            ...
            for cur_comp_strat in strategy_combinations[cur_no_pitstops]:
                ...
                t_race_fastest.append([tuple(strategy_stints), t_race_tmp])
    ...
    # ------------------------------------------------------------------------------------------------------------------
        ...
        if not exit_qp:
            ...
            for cur_no_pitstops in t_race_fastest:
                t_race_fastest = sorted(t_race_fastest, key=lambda x: x[1])
...
if __name__ == '__main__':
    ...
    sim_opts_ = {"min_no_pitstops": 0,
                 "max_no_pitstops": 2,
                 "start_compound": 'A5',
                 "start_age": 0,
                 "enforce_diff_compounds": False,
                 "use_qp": False,
                 "fcy_phases": None}
